...
class Summary(Base):
    ...
    decisions = Column(Text) # store as JSON string or move to its own table later if needed
    agenda_status = Column(Text) # JSON string: {agenda_item: covered/not_covered}
